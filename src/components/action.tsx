...
const colorMap: Record<Props["color"], Record<"active" | "inactive", string>> =
  {
    ...
    Violet: {
      active:
        "text-slate-600 bg-transparent hover:text-violet-600 hover:bg-violet-50",
      inactive:
        "text-slate-600 bg-transparent hover:text-violet-600 hover:bg-violet-50",
    },
    Pink: {
      active:
        "text-pink-900 bg-transparent hover:text-pink-600 hover:bg-pink-50",
      inactive:
        "text-slate-600 bg-transparent hover:text-pink-600 hover:bg-pink-50",
    },
  };
